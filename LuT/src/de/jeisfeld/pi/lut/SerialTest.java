...
/**
 * Test class for the serial interface.
 */
public final class SerialTest {
	 ...
	 */
	public static void main(final String args[]) throws InterruptedException, IOException { // SUPPRESS_CHECKSTYLE
